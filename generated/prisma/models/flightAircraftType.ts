...
// @ts-nocheck 
/*
 * This file exports the `flightAircraftType` model and its related types.
 *
...
export type GetFlightAircraftTypeAggregateType<T extends FlightAircraftTypeAggregateArgs> = {
      [P in keyof T & keyof AggregateFlightAircraftType]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateFlightAircraftType[P]>
    : Prisma.GetScalarType<T[P], AggregateFlightAircraftType[P]>
}
...
type GetFlightAircraftTypeGroupByPayload<T extends flightAircraftTypeGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<FlightAircraftTypeGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof FlightAircraftTypeGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], FlightAircraftTypeGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], FlightAircraftTypeGroupByOutputType[P]>
      }
    >
  >
...
export type flightAircraftTypeCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<flightAircraftTypeFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface flightAircraftTypeDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['flightAircraftType'], meta: { name: 'flightAircraftType' } }
  /**
   ...
   * })
  **/
  count<T extends flightAircraftTypeCountArgs>(
    args?: Prisma.Subset<T, flightAircraftTypeCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], FlightAircraftTypeCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends flightAircraftTypeGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, flightAircraftTypeGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetFlightAircraftTypeGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
