...
// @ts-nocheck 
/*
 * This file exports the `aircraftType` model and its related types.
 *
...
export type GetAircraftTypeAggregateType<T extends AircraftTypeAggregateArgs> = {
    ...
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateAircraftType[P]>
    : Prisma.GetScalarType<T[P], AggregateAircraftType[P]>
}
...
type GetAircraftTypeGroupByPayload<T extends aircraftTypeGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<AircraftTypeGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof AircraftTypeGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], AircraftTypeGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], AircraftTypeGroupByOutputType[P]>
      }
    >
  >
...
export type aircraftTypeCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
...
export interface aircraftTypeDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  **/
  count<T extends aircraftTypeCountArgs>(
    args?: Prisma.Subset<T, aircraftTypeCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], AircraftTypeCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, aircraftTypeGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetAircraftTypeGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
